    ...
    <tbody>
        @foreach ($data as $item)
            <tr>
                ...
                <td>
                    <span class="fs-6 ms-3 fw-bold text-success">
                ...
                <td>
                    <button class="btn btn-success" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvas_{{$item->id}}" aria-controls="offcanvas_{{$item->id}}">
                        Mais Informações
                    </button>
